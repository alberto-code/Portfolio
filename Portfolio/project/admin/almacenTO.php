...
<div class="almacen">
    ...
    <div class="filtroBusqueda">
            <select id="buscadorAlmacen" onchange="BuscadorAlmacen()">
                <option>TODOS</option>
...
<a href="#" id="abrirModalAgregarElemento">
    <button>
        Agregar elemento
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M4 3C3.44772 3 3 3.44772 3 4V10C3 10.5523 3.44772 11 4 11H10C10.5523 11 11 10.5523 11 10V4C11 3.44772 10.5523 3 10 3H4ZM4 13C3.44772 13 3 13.4477 3 14V20C3 20.5523 3.44772 21 4 21H10C10.5523 21 11 20.5523 11 20V14C11 13.4477 10.5523 13 10 13H4ZM14 13C13.4477 13 13 13.4477 13 14V20C13 20.5523 13.4477 21 14 21H20C20.5523 21 21 20.5523 21 20V14C21 13.4477 20.5523 13 20 13H14ZM15 19V15H19V19H15ZM5 9V5H9V9H5ZM5 19V15H9V19H5ZM16 11V8H13V6H16V3H18V6H21V8H18V11H16Z"></path></svg>
    </button>
</a>
...
<div id="modalAgregarElemento" class="modalAddForm">
    <div class="addForm">
        <div class="form">
            ...
            <form id="formAgregarElemento" method="POST" enctype="multipart/form-data">
                ...
                <input required name="nombre" placeholder="Nombre de producto" type="text">
                <input required name="codigo" placeholder="Código" type="text">
                ...
                <input id="file-upload" name="imagen" placeholder="Imagen" type="file" accept="image/*">
    ...
    <div class="almacenGrid" id="almacenTo">
        <div class="loading">
    ...
    <?php
        ...
        $SQL = mysqli_query($enlace, "SELECT * FROM elementos WHERE TONE = '1'");
        if (mysqli_num_rows($SQL) > 0) {
            while ($tabla = mysqli_fetch_array($SQL)) {
                echo '
                <div id="elemento-' . htmlspecialchars($tabla['ID_elemento'], ENT_QUOTES, 'UTF-8') . '" class="almacenDiv">
                   <div class="almacenDivButton">
                       <h2>' . htmlspecialchars($tabla['tipo'], ENT_QUOTES, 'UTF-8') . '</h2>
                       <a onclick="mostrarConfirmacionBorrado(' . htmlspecialchars($tabla['ID_elemento'], ENT_QUOTES, 'UTF-8') . ')">
                   ...
                   <div class="almacenDivData">
                       <h2>' . htmlspecialchars($tabla['nombre'], ENT_QUOTES, 'UTF-8') . '</h2>
                   </div>

                   <div id="confirmacion-' . htmlspecialchars($tabla['ID_elemento'], ENT_QUOTES, 'UTF-8') . '" class="confirmacionBorrado ocultandoConfirmacionBorrado">
                       <div class="confirmacionBorradoDiv">
                           ...
                           <span>
                               <button onclick="mostrarConfirmacionBorrado(' . htmlspecialchars($tabla['ID_elemento'], ENT_QUOTES, 'UTF-8') . ')">
                               ...
                               <a onclick="borrarElemento(' . htmlspecialchars($tabla['ID_elemento'], ENT_QUOTES, 'UTF-8') . ', \'elemento\')">
                                   <button>
                                       <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
