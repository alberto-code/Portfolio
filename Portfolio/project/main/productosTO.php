...
<div class="elementosDiv">
    ...
    <?php
        ...
        $SQL = mysqli_query($enlace, "SELECT * FROM elementos WHERE TONE = '1' AND tipo = 'Productos' ");
...
<?php
include_once($_SERVER['DOCUMENT_ROOT'] . '/Creatone/footer.php');
?>